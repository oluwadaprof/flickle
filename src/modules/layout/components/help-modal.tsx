...
const HelpModal = ({ open, onOpenChange }: HelpModalProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-lg bg-card border-border max-h-[80vh] overflow-hidden p-0 [&>button]:z-20 [&>button]:top-6 [&>button]:right-6 " >
                ...
                >
                    <div className="space-y-6">
                        ...
                        <div className="p-4 bg-primary/10 rounded-lg border border-primary/20">
                            <h4 className="font-display text-base text-primary mb-2">
                                Color Guide
                            </h4>
